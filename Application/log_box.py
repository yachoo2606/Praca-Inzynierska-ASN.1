    ...
    def draw_box(self):
        ...
        if len(self.log_to_draw) < 8:
            for i in range(len(self.log_to_draw)):
                self.WIN.blit(self.log_font.render(self.log_to_draw[i], True, (0, 0, 0)), (710, (630 + 17 * i)))
        else:
            for i in range(8):
                self.WIN.blit(self.log_font.render(self.log_to_draw[len(self.log_to_draw) - 8 + i], True, (0, 0, 0)),
                              (710, (630 + 17 * i)))
